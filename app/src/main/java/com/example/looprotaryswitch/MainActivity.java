...
//                Toast.makeText(MainActivity.this, "setOnItemSelectedListener－－－i="+position, Toast.LENGTH_SHORT).show();
    ...
    private void initData() {
        views=new ArrayList<>();
        View view0= LayoutInflater.from(this).inflate(R.layout.loopview_item_view0,null);//我
        View view1= LayoutInflater.from(this).inflate(R.layout.loopview_item_view1,null);//爱
        View view2= LayoutInflater.from(this).inflate(R.layout.loopview_item_view2,null);//你
        View view3= LayoutInflater.from(this).inflate(R.layout.loopview_item_view4,null);//吗
        View view4= LayoutInflater.from(this).inflate(R.layout.loopview_item_view5,null);//吗
        views.add(view0);
        views.add(view1);
        views.add(view2);
        views.add(view3);
